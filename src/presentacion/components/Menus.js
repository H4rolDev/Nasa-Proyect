    ...
    <div className="menus">
      <div className="menu">
        <button
          ...
          onClick={() => toggleMenu("descripcion")}
        >
          Description
        </button>
      ...
      <div className="menu">
        <button
          className="buttonDates"
          onClick={() => toggleMenu("exploraciones")}
        >
          Explorations
        </button>
      ...
      <div className="menu">
        <button
          className="buttonDates"
          onClick={() => toggleMenu("curiosidades")}
        >
          Curiosities
        </button>
      ...
      <div className="menu">
      <button className='buttonDates' onClick={() => window.open(planeta.masInformacion, "_blank", "noopener,noreferrer")}>
        Más Información
      </button>
      </div>
    </div>
